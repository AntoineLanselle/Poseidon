...
public class UserServiceImpl implements UserService {
	 ...
	 * 
	 *
	 * @Override public User getCurrentUser() { Authentication auth =
	 *           SecurityContextHolder.getContext().getAuthentication(); if (auth !=
	 *           null) { return userRepository.findByUsername(auth.getName()); }
	 *           else { return null; } }
	 */
	 ...
	 *           userRepository.findByUsername(username); if (user == null) { String
	 *           error = "User with id:" + username + " not found"; throw new
	 *           UsernameNotFoundException(error); } else { return new
